  ...
  const educationData = [
    {
      ...
      place: "Karunya Institute of Technology & Sciences",
      color: "bg-purple-100",
      details: (
        <ul className="list-disc list-inside">
          <li>CGPA: 7.75/10</li>
          <li>Focus: Distributed Systems, Cloud & Infrastructure, AI/ML</li>
        </ul>
      )
    }
  ];
