  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between px-6 md:px-10 py-6">
            <h2 className="text-3xl md:text-4xl font-shrikhand text-black uppercase tracking-wide">HACKATHONS</h2>
            <button 
              onClick={onToggle} 
              aria-expanded={isOpen}
              aria-label={`${isOpen ? 'Close' : 'Open'} hackathons`}
                ...
                <div className="px-6 md:px-10 pb-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[-4px] transition-all flex flex-col h-full relative bg-white">
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <div className="flex justify-between items-start mb-4 gap-4">
                                    <h3 className="text-xl font-bold leading-snug">Smart India Hackathon 2025 (ISRO Track)</h3>
                                    <span className="text-3xl flex-shrink-0">🏆</span>
                                </div>
                                <p className="font-bold text-lg mb-2 text-custom-red">Grand Finale Top 5</p>
                                <p className="text-sm font-medium text-gray-700 leading-relaxed border-t-4 border-black border-dashed pt-4 mt-auto">
                                    ISRO Space Technology Track; quantized and deployed the thermal SR model on NVIDIA Jetson.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[-4px] transition-all flex flex-col h-full relative bg-white">
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <div className="flex justify-between items-start mb-4 gap-4">
                                    <h3 className="text-xl font-bold leading-snug">Bharatiya Antariksh Hackathon 2025 (ISRO)</h3>
                                    <span className="text-3xl flex-shrink-0">🥈</span>
                                </div>
                                <p className="font-bold text-lg mb-2 text-custom-blue">4th Place Nationally</p>
                                <p className="text-sm font-medium text-gray-700 leading-relaxed border-t-4 border-black border-dashed pt-4 mt-auto">
                                    Led satellite image super-resolution work among 61,000+ students across 8,744 teams; achieved 41.45 dB PSNR and 0.97 SSIM on the official ISRO test set.
                                </p>
                            </div>
                        </div>
                    </div>
